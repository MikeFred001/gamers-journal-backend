 ...
 *
 * Input Query: { searchTerm: "search term" }
 * Returns JSON: [ { id, description, image, name, platforms, releaseDate }, {}... ]
 */
router.get('/games', cors({
    ...corsOptions, headers: { 'Content-Type': 'application/json' }
}),
    async (req, res, next) => {
        try {
